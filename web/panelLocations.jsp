...
<div class="py-5">
    <div class="container my-5">
        <div class="row">
            <div class="col-md-12">
                <h1 class="display-1">Locales de : ${business.name}</h1>
            </div>
            ...
            <div class="col-md-12">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><c:out value="${location.startTime}"/></td>
                        <td><c:out value="${location.closeTime}"/></td>
                        <td><c:out value="${location.actualCapacity}"/></td>
                    </tr>
                    </tbody>
                    </c:forEach>
                </table>
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="css/locations.css" type="text/css"> </head>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 my-3">
                <h1 class="display-4 text-white text-md-left text-center"> Locales de: ${business.name} &nbsp;</h1>
            </div>
            <div class="col-md-5  text-center align-self-center">
                <a href="businesses?action=index" target="_blank"><i class="fa fa-fw fa-3x text-white mx-3 fa-arrow-left" id="return"></i></a>
                <a href="<c:out value="${business.social}"/>" target="_blank"><i class="fa fa-fw fa-facebook fa-3x text-white mx-3" id="facebooPage"></i></a>
                <a href="https://twitter.com/" target="_blank"><i class="fa fa-fw fa-twitter fa-3x text-white mx-3"></i></a>
                <a href="https://www.instagram.com/" target="_blank"><i class="fa fa-fw fa-instagram fa-3x text-white mx-3"></i></a>
            </div>
